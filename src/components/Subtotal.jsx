          ...
          renderText={(value) => (
            <div className='md:mb-2 -mb-2'>
              <div className="flex flex-row items-baseline">
                <span className='text-[0.5rem] font-medium md:text-lg text-[#0f1111] md:mb-1'>Subtotal (0 items):</span>
                <span className='ml-1 font-semibold text-xs md:text-2xl'>0</span>
              </div>
